      ...
      if (index == 4) {
        ...
        if (otp.length === 4 && _this2.oTP.forth != '') {
          ...
          _this2.api.validarOtp(data).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.finalize)(() => {
            ...
            var _ref2 = (0,_Users_desarrolloporsalud_HELP_Ecosistema_HELP_Ajustadores_AjustadoresHN_Dev_210_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (err) {
              console.log(err);
