...
let MapaPage = class MapaPage {
  constructor(router, toaster, platform, so, location) {
    ...
    */
    ...
    this.api.DatosDeAtencion(this.idAtencion).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.finalize)( /*#__PURE__*/(0,_Users_desarrolloporsalud_HELP_Ecosistema_HELP_Ajustadores_AjustadoresHN_Dev_210_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      alert('Ahora si');
    ...
    return (0,_Users_desarrolloporsalud_HELP_Ecosistema_HELP_Ajustadores_AjustadoresHN_Dev_210_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.trackInterval = setInterval(() => {
        ...
        if (_this2.moveCoords) {
          ...
          _this2.api.setPositionNRoute(jsonPosition).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.finalize)( /*#__PURE__*/(0,_Users_desarrolloporsalud_HELP_Ecosistema_HELP_Ajustadores_AjustadoresHN_Dev_210_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            console.log('fin');
