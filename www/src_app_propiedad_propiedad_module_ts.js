  ...
  next() {
    ...
    return (0,C_Users_edwyn_mcclellan_Documents_GitHub_AppAjustadoresHelp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this.propiedadPrivadaList.length > 0) {
        ...
        yield load.present();
        _this.api.GuardarPropiedadTercero(_this.propiedadPrivadaList).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.finalize)( /*#__PURE__*/(0,C_Users_edwyn_mcclellan_Documents_GitHub_AppAjustadoresHelp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          yield load.dismiss();
        }))).subscribe(res => {
