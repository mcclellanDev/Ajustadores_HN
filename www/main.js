...
const routes = [{
  ...
  path: 'login',
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_sesion_login_login_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./sesion/login/login.module */ 59293)).then(m => m.LoginPageModule)
}, {
  path: 'recovery',
  ...
  path: 'expediente',
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_expediente_expediente_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./expediente/expediente.module */ 66409)).then(m => m.ExpedientePageModule)
}, {
  path: 'formulario',
  ...
  path: 'adeuda',
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_signature_pad_dist_signature_pad_js"), __webpack_require__.e("src_app_adeuda_adeuda_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./adeuda/adeuda.module */ 46952)).then(m => m.AdeudaPageModule)
}, {
  path: 'culpable',
  ...
  path: 'finiquito',
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_signature_pad_dist_signature_pad_js"), __webpack_require__.e("src_app_finiquito_finiquito_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./finiquito/finiquito.module */ 64093)).then(m => m.FiniquitoPageModule)
}, {
  path: 'beneficiario',
...
let AppComponent = class AppComponent {
  constructor(plt, api, platform, so, tostador, router, connectionService) {
    this.plt = plt;
    this.api = api;
  ...
  checkConnection() {
    ...
    _capacitor_network__WEBPACK_IMPORTED_MODULE_8__.Network.addListener("networkStatusChange", status => {
      ...
      localStorage.setItem('conectividad', this.conectividad.toString());
      if (this.conectividad == false) {
        jquery__WEBPACK_IMPORTED_MODULE_12__('#connectIndicator').fadeIn();
        //this.toaster.toastMessage = 'No hay conexión a internet';
        //this.toaster.toastClass = 'conectividad';
        //this.toaster.presentToastErrorConexion(this.toaster.toastMessage, this.toaster.toastPosition, this.toaster.toastClass);
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_12__('#connectIndicator').fadeOut();
      }
    });
  }
  /*
  ...
  */
  initializeApp() {
    var _this = this;
    this.plt.ready().then( /*#__PURE__*/(0,C_Users_edwyn_mcclellan_Documents_GitHub_AppAjustadoresHelp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  ngOnInit() {
    ...
    this.router.events.subscribe(e => {
      if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_13__.ActivationStart && e.snapshot.outlet === "root") this.outlet?.deactivate();
    });
  ...
  outletDeactivate() {
    this.router.events.subscribe(e => {
      if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_13__.ActivationStart && e.snapshot.outlet === "tab1") this.outlet?.deactivate();
    });
  }
  ionViewDidEnter() {
    this.platform.ready().then(() => {
  ...
  static {
    this.propDecorators = {
      ...
      outlet: [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_15__.ViewChild,
        args: [_angular_router__WEBPACK_IMPORTED_MODULE_13__.RouterOutlet]
      }]
    };
  }
};
...
JwtInterceptor = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Injectable)()], JwtInterceptor);
...
/* harmony import */ var _environments_signatures__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../environments/signatures */ 88538);
/* harmony import */ var _toast_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./toast.service */ 84465);
...
let ApiService = class ApiService {
  constructor(http, router, toaster) {
    ...
    this.firmaDemoAjustador = _environments_signatures__WEBPACK_IMPORTED_MODULE_5__.firmaDemoAjustador;
    this.emptySignature = _environments_signatures__WEBPACK_IMPORTED_MODULE_5__.emptySignature;
    this.emptySignatureWhite = _environments_signatures__WEBPACK_IMPORTED_MODULE_5__.emptySignatureWhite;
  ...
  request(urlRequest, data) {
    ...
    return (0,C_Users_edwyn_mcclellan_Documents_GitHub_AppAjustadoresHelp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      console.log(options);
      const response = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_4__.CapacitorHttp.post(options);
    })();
  }
  loadToken() {
    var _this2 = this;
  ...
  MisAtenciones(credentials) {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
  ...
  GuardarPropiedadTercero(credentials) {
    return this.http.post(`${this.apiUrl}/Proveedor/GuardarPropiedadDaniadaSiniestro_HN`, credentials).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  GuardarCacheCliente(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/GuardarCacheCliente`, cacheData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.of)(res);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  GuardarSiniestroHN(envioData) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/GuardarInformeSiniestros_HN`, envioData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.of)(res);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  GuardarSiniestroHN_Sin_Poliza(siniestroData) {
    ...
    console.dir(siniestroData);
    return this.http.post(`${this.apiUrl}/Proveedor/GuardarInformeSiniestros_HN`, siniestroData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.of)(res);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  */
  ...
  ActualizarAudicion(audicion) {
    return this.http.post(`${this.apiUrl}/Proveedor/ActualizarAudicion?IdAjustadorAudiencia=${audicion.IdAjustadorAudiencia}&RefProveedorAgenteAbogadoId=${audicion.RefProveedorAgenteAbogadoId}
      ...
      audicion
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ObtenerIdTablaAjustador(IdAtencion) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/ObtenerIdTablaAjustador?IdAtencion=${IdAtencion}`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ObtenerEstadoLog(IdAtencion) {
    return this.http.post(`${this.apiUrl}/Proveedor/ObtenerEstadoLog?IdAtencion=${IdAtencion}`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  GuardarVideo(file, idAtencion) {
    ...
    return this.http.post(this.filesUrl, formData).pipe(e => {
      try {
        console.log(e);
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(e);
      } catch (ex) {
        console.log(ex);
      }
    }, (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
  ...
  login(credentials) {
    ...
    //switchMap((tokens: {accessToken, refreshToken }) => {
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(Data => {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all([storeAccess, userData]));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  }
  ...
  GetAppVersion(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Login/GetAppVersion?plataforma=${credentials}`, versionData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTiposDeFotografia() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeFotografia`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoSiniestroFicohsa() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TiposDeSiniestroFicohsa`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoConductor() {
    ...
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeConductor`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  ListTipoGenero() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeGenero`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoParentesco(idPais) {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TiposDeParentescoFicohsa?IdPais=${idPais}`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoSiniestro(idPais) {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TiposDeSiniestroFicohsa?IdPais=${idPais}`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoDeAudiencia() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeAudiencia`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoCombustible() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeCombustible`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  TipoDeLicencia(paisId) {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeLicencia?IdPais=${paisId}`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  TipoDeVehiculo(paisId) {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TiposDeVehiculosFicohsa?IdPais=${paisId}`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  listDanios() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/ListadoDanioAlVehiculoFicohsa`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTalleres() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/ListadoTalleresFicohsa`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListarTiposAcuerdo() {
    return this.http.get(`${this.apiUrl}/Proveedor/ListaTipoAcuerdos`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  obtenerFotoPorAtencion(atencionId, TipoFotoFirma) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/ListaFotografiasFirmasAtencion`, body).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  obtenerCoordenadasPorAtencion(atencionId, Tipo) {
    ...
    // ?IdAtencion=${atencionId}&TipoFotoFirma=${TipoFotoFirma}
    return this.http.get(`${this.apiUrl}/Proveedor/VectorGpsAtencion?IdAtencion=${atencionId}&Tipo=${Tipo}`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  setAjuPosition(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/ActualizarCordenadasAjustador?Longitud=${credentials.Longitud}&Latitud=${credentials.Latitud}&IdProveedorAgente=${credentials.RefUsuarioId}`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  setPositionNRoute(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/InsertarCoordenadasAtencionAgenteProveedor`, jsonPosition).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  insertarConvenioReparacion(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/InsertarConvenioReparacionTaller`, jsonRepara).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  InsertarConvenioReparacionTallerExtra(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/InsertarConvenioReparacionTallerExtra`, jsonRepara).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  insertarFiniquitoManual(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/InsertarFiniquitoManual`, jsonFiniquito).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  */
  ListTipoDeEntidadComunicativa() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeEntidadComunicativa`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListMarcasVehiculosFicohsa() {
    return this.http.get(`${this.apiUrl}/Proveedor/ListaVehiculosFicohsa`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoDeSolicitanteInformeAjuste() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDeSolicitanteInformeAjuste`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  ListTipoDePersonaSiniestro() {
    return this.http.get(`${this.apiUrl}/SeleccionMultiple/TipoDePersonaSiniestro`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
      this.isAuthenticated.next(true);
    }));
  ...
  GuardarBPM(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/FicohsaHN/Carga_Reclamo_Sinau_BPM_Fico`, misdatos).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
  ...
  insertarHospitalizacion(credentials) {
    ...
    return this.http.post(`${this.apiUrl}/Proveedor/InsertarLesionesHospitalizacion?IdAjustadorAudiencia=${credentials.IdAjustadorAudiencia}&TipoLesionesTercerosAfectados=${credentials.TipoLesionesTercerosAfectados}&NombreHospital=${credentials.NombreHospital}`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(res => {
      console.log('Respuesta de ingresar la nueva atencion ');
      console.dir(res);
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all(res));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(_ => {
  ...
  logout() {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.from)(Promise.all([deleteAccess, deleteUserData])); //, deleteRefresh]));
    //  }),
    //  tap(_ => {
    // this.isAuthenticated.next(false);
...
ApiService = (0,tslib__WEBPACK_IMPORTED_MODULE_15__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_16__.Injectable)({
  providedIn: 'root'
})], ApiService);
...
let ToastService = class ToastService {
  constructor(toaster, miApi, loading, router) {
    this.toaster = toaster;
    this.miApi = miApi;
    this.loading = loading;
    this.router = router;
...
ToastService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
  providedIn: 'root'
})], ToastService);
